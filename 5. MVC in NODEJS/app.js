...
app.set('view engine','ejs'); // set the view engine as ejs so that it can also render the .pug extension
app.set('views','views'); // to set default folder
...
app.listen(3200); // this is equal to above code because same code is written in express ripo.